...
class CreateView(MethodView):
    ...
    def get(self,
        ...
        if terms_agreed is not None:
            ...
            # Redirect to `/dataset/terms` route
...
sigma2_dataset.add_url_rule(u'/', view_func=search, strict_slashes=False)
sigma2_dataset.add_url_rule(u'/new', view_func=CreateView.as_view(str(u'new')))
sigma2_dataset.add_url_rule(u'/<id>', view_func=read)
sigma2_dataset.add_url_rule(u'/resources/<id>', view_func=resources)
...
sigma2_dataset.add_url_rule(u'/followers/<id>', view_func=followers)
sigma2_dataset.add_url_rule(
