...
class Sigma2CreateView(CreateView):
    def post(self, package_type: str, id: str) -> Union[str, Response]:
        ...
        if save_action == u'go-metadata':
            ...
            return h.redirect_to(u'{}.review'.format(package_type), id=id)
...
def register_dataset_plugin_rules(blueprint: Blueprint) -> None:
    blueprint.add_url_rule(u'/new', view_func=Sigma2CreateView.as_view(str(u'new')))
